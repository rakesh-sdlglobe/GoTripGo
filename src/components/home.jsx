            ...
            <div className="row justify-content-center mb-4">
              <div className="col-lg-8 text-center">
                <h2 className="fw-bold fs-2">
                  Why Book Your Train Journey with Go Trip Go?
                </h2>
        ...
        <div className="accordion accordion-flush" id="accordionFlushExample">
          <div className="accordion-item border">
            <h2 className="accordion-header rounded-2">
              ...
              >
                How do I book train tickets online through Go Trip Go?
              </button>
            </h2>
            <div
            ...
            >
              <div className="accordion-body">
                Booking through Go Trip Go is quick and simple:
                ...
                Your e-ticket will be sent instantly via email and SMS. You can also download it from your Go Trip Go account.
              </div>
            </div>
          </div>
